    ...
    func getProtocols(onCompletion: @escaping ([ProtocolModel]) -> Void) {
        DispatchQueue.global(qos: .default).async {
            onCompletion([
                ...
                ProtocolModel(name: "AProtokoll - 1", url: "https://elearning.uni-obuda.hu/main/pluginfile.php/415651/mod_resource/content/1/03-Virtualization%20Technologies.pdf"),
